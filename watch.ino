...
//OLED и DS3231 подключаются всесте к: SCL - A5 // SDA - A4;
...
//P.S. если в кратце, то часы настраиваются из примера в библиотеке, а так же нужно выпаять один диод на плате
//Подробнее про модуль часов DS3231 можно посмотреть в обзорах на youtube, напимер у arduinoLab
